...
describe("BehavioralHeuristicsService", () => {
  ...
  describe("detectContentSimilarity", () => {
    ...
    it("detects similar content from different DIDs", async () => {
      ...
      const similarContent = "This is a test post with enough content to generate meaningful trigrams for comparison purposes";
      const topicRows = [
      ...
      mockDb.select
        ...
        .mockReturnValueOnce(replySelectChain);
