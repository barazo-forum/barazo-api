...
export function onboardingRoutes(): FastifyPluginCallback {
  return (app, _opts, done) => {
    ...
    app.get("/api/admin/onboarding-fields", {
    ...
    app.post("/api/admin/onboarding-fields", {
      preHandler: [requireAdmin],
      schema: {
        tags: ["Admin"],
    ...
    app.put<{ Params: { id: string } }>("/api/admin/onboarding-fields/:id", {
      preHandler: [requireAdmin],
      schema: {
        tags: ["Admin"],
    ...
    app.delete<{ Params: { id: string } }>("/api/admin/onboarding-fields/:id", {
      preHandler: [requireAdmin],
      schema: {
        tags: ["Admin"],
    ...
    app.put("/api/admin/onboarding-fields/reorder", {
      preHandler: [requireAdmin],
      schema: {
        tags: ["Admin"],
    ...
    app.post("/api/onboarding/submit", {
      ...
      app.log.info(
        { event: "onboarding_submitted", did: user.did, fieldCount: parsed.data.length, complete },
